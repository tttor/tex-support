...
\newcommand{\eqreffb}[2]{Eqns~\ref{#1} and \ref{#2}}
\newcommand{\eqreffand}[2]{Eqns~\ref{#1} and \ref{#2}}

\newcommand{\figref}[1]{Fig~\ref{#1}}
\newcommand{\figrefb}[2]{Fig~\ref{#1} and \ref{#2}}
\newcommand{\figrefand}[2]{Figs~\ref{#1} and \ref{#2}}
\newcommand{\figrefc}[3]{Fig~\ref{#1}, \ref{#2}, and \ref{#3}}
\newcommand{\figrefd}[4]{Fig~\ref{#1}, \ref{#2}, \ref{#3}, and \ref{#4}}
