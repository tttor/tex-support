...
\newcommand{\areset}{a^{\mathrm{reset}}}
...
\newcommand{\epb}{e_{\mathbb{PB}}} % mean squared Bellman projected error
...
\newcommand{\szrat}{s^{\mathrm{zrat}}} % zrat: zero reward absorbing terminal
\newcommand{\sreset}{s^{\mathrm{reset}}}
...
\newcommand{\wtd}{\vecb{w}_{\mathrm{TD}}} % action advantage
